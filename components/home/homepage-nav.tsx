            ...
            <SheetTrigger
              render={
                <button
                  ...
                  className="-mr-2 inline-flex h-9 w-9 cursor-pointer items-center justify-center text-white transition-opacity duration-150 hover:opacity-80 md:-mr-1 md:h-10 md:w-10"
                />
              }
            >
                    ...
                    <SheetClose
                      render={
                        <button
                          ...
                          className="inline-flex h-9 w-9 cursor-pointer items-center justify-center text-white transition-opacity duration-150 hover:opacity-80 md:h-10 md:w-10"
                        />
                      }
                    >
