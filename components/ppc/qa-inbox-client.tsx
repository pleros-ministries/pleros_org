              ...
              {selectedThread.status === "open" && (
                <div className="grid gap-2">
                  <textarea
                    ...
                    rows={3}
                    className="w-full rounded-md border border-zinc-200 px-3 py-2 text-xs text-zinc-700 outline-none placeholder:text-zinc-400 focus:border-zinc-400"
                  />
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={handleClose}
                      disabled={isPending}
                      className="flex h-7 items-center gap-1.5 rounded-md border border-zinc-200 px-3 text-xs font-medium text-zinc-600 hover:bg-zinc-50 disabled:opacity-50"
                    >
