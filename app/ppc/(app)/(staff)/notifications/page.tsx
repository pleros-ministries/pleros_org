      ...
      <section className="grid gap-4 lg:grid-cols-[1.2fr_1fr]">
        <article className="rounded-sm border border-zinc-200 bg-white p-4">
          ...
          <div className="mt-3 grid gap-2">
            {DEMO_NOTIFICATIONS.map((item) => (
              <div
                key={item.id}
                className="flex flex-wrap items-center justify-between gap-3 rounded border border-zinc-200 bg-zinc-50 px-3 py-2"
              >
                <div>
        ...
        <article className="rounded-sm border border-zinc-200 bg-white p-4">
          ...
          <ul className="mt-3 grid gap-2 text-sm text-zinc-700">
            <li className="rounded border border-zinc-200 bg-zinc-50 px-3 py-2">
