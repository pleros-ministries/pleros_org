      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <article className="rounded-sm border border-zinc-200 bg-white p-4">
          ...
          <ul className="mt-3 grid gap-2 text-sm text-zinc-700">
            <li className="rounded-sm border border-zinc-100 bg-zinc-50 px-3 py-2">
        ...
        <article className="rounded-sm border border-zinc-200 bg-white p-4">
          ...
          <ul className="mt-3 grid gap-2 text-sm text-zinc-700">
            <li className="flex items-center gap-2 rounded-sm border border-zinc-100 bg-zinc-50 px-3 py-2">
          ...
          <div className="mt-4">
            ...
            <ul className="mt-2 grid gap-1.5 text-xs text-zinc-600">
              <li className="rounded-sm border border-zinc-100 px-3 py-1.5">Submission reviewed (approved / needs revision)</li>
              <li className="rounded-sm border border-zinc-100 px-3 py-1.5">New Q&A reply from staff</li>
              <li className="rounded-sm border border-zinc-100 px-3 py-1.5">Level graduation confirmed</li>
              <li className="rounded-sm border border-zinc-100 px-3 py-1.5">Inactivity reminder triggered</li>
            </ul>
          </div>
        </article>
      </section>
