...
- SOGP enrolment page has no navbar and captures required first/last name, E.164 phone number, independently editable country of residence, and required state/province/region; default country comes from Vercel IP country with Nigeria fallback, and the form carries the approved privacy assurance.
