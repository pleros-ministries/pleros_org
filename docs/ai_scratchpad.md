...
- Core SOGP remains four weeks: 20 required weekday teachings completed through assessments, Prayer Watch every day, four required weekend review sessions completable live or by recording, and four optional Extras outside the calendar/certificate calculation. Discipline replaces Commitment in Level 1; curriculum placement remains independent of the source lesson level.
...
- SOGP formation requirements are certificate-gating: all 20 core assessments, Morning Prayer Watch on at least 80% of cohort dates, and all four required reviews. Podcast is independent dashboard content and must not affect SOGP calendar state, progress, or eligibility.
