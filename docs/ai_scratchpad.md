...
- SOGP enrolment email uses soft sky/white surfaces and progressively enhances to the public Sen/Be Vietnam Pro pairing while remaining layout-safe in Arial/Helvetica; keep CTA weight at 500 and protect classic Outlook with an explicit MSO fallback.
