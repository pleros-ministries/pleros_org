...
- First SOGP curriculum is 20 certificate-required weekday tracks plus up to four optional Level 3 tracks released for Saturday live sessions. Discipline replaces Commitment in SOGP Level 1; SOGP curriculum placement is independent of the teaching’s PPC source level. Optional tracks never affect certification.
...
- Live DB verification on 2026-08-22 found all 5 Level 1 and all 11 Level 2 lessons published and content-ready. Known practical display titles include Discipline – The Foundation of the Pursuit of Purpose, Being Led by the Spirit of God, The Life of Devotion, and Ministering and Receiving Christ’s Healing Power; backend Level 3 rows remain generic drafts and the user must select one additional required plus four optional topics before cohort activation.
...
- SOGP enrolment page has no navbar and captures required first name/surname in separate fields, E.164 phone number, independently editable country of residence, required state/province/region, selected year of birth, and a required “How did you hear about us?” source; default country comes from Vercel IP country with Nigeria fallback, and the form carries the approved privacy assurance. WhatsApp reminders require an optional, unchecked, auditable opt-in with an opt-out notice. Do not restore the removed outcome/free-text question.
